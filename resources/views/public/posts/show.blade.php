            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        @if ($liked)
                            <a href="{{ route('public.posts.unlike', $post->slug) }}"
                                class="text-red-500 dark:text-red-300 hover:underline">
                                <i class="fa-solid fa-heart"></i> {{ $like }}
                            </a>
                        @else
                            <a href="{{ route('public.posts.like', $post->slug) }}"
                                class="text-red-500 dark:text-red-300 hover:underline">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div class="mt-2 flex justify-start items-center">
                                <a href="{{ route('public.posts.show.category', $post->category->slug) }}"
                                ...
                                <a href="{{ route('public.posts.show.company', $post->company->slug) }}"
                    ...
                    <div class="mt-4">
                        <a href="{{ route('public.posts.index') }}" class="text-blue-500 hover:underline">
                        {{ __('Back') }}
                        </a>
                    </div>
                </div>
