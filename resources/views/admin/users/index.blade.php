        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    @else
                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Admin: {{ $admins->count() }}</h4>
                    @endif
                        ...
                        <table id="admins-table" class="min-w-full bg-white dark:bg-gray-800 mb-8">
                            <thead class="bg-gray-300 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="py-2 px-4 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        Action</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300">{{ $admin->email }}
                                        </td>
                    ...
                    @else
                    <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Creator: {{ $creators->count() }}</h4>
                    @endif
                    <div class="overflow-x-auto table-wrapper">
                        <table id="creators-table" class="min-w-full bg-white dark:bg-gray-800 mb-8">
                            ...
                            @foreach ($creators as $creator)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300">{{ $creator->name }}
                                    </td>
                                    <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300">
                                        {{ $creator->email }}</td>
                                        <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300 text-center">
                                            <form action="{{ route('admin.users.destroy', $creator->id) }}" method="POST"
                                                onsubmit="return confirm('Are you sure?');">
                                                @csrf
                                            @method('DELETE')
                                            <button type="submit"
                    ...
                    @else
                        <h4 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Public: {{ $publics->count() }}</h4>
                    @endif
                    <div class="overflow-x-auto table-wrapper">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($publics as $public)
                                <tr>
                                    ...
                                    <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300">{{ $public->name }}
                                    </td>
                                    <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300">{{ $public->email }}
                                    </td>
                                    <td class="py-2 px-4 text-sm text-gray-500 dark:text-gray-300 text-center">
                                        <form action="{{ route('admin.users.destroy', $public->id) }}" method="POST"
                                            onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
